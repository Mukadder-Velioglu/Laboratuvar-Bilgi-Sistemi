...
<a class="nav-link active" href="doktorekran.php"><img id="logo" src="logo4.png" alt="Smiley face" height="57" width="57"><img id="logo" src="logoo.png" alt="Smiley face" height="30" width="65"></a>
	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			<div class="card-header">
				<center><h4>ŞİFREMİ UNUTTUM</h4></center>
			</div>
			<div class="card-body">
				<form class="formm" action="sifre_yenile.php" method="post">
				  <div class="form-row">
					<div class="col-md-12 mb-1">
					  <input type="text" name="eposta" class="form-control" id="inputEmail4" placeholder="Eposta" required>
					</div>
				...
				?>
				  ...
				  <div class="form-group row">
					<div class="col-md-12">
					  <center><button type="submit" class="btn btn-info" id="kaydet">Gönder</button></center>
					</div>
				  </div>
				  <br>
				  <br>
